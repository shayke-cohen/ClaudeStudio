...
| 2026-04-18 | Multi-model agent variants and cross-model group presets. Added default agent configs: Coder (Codex), Coder (Sonnet), Coder (Local), Tester (Haiku), Attacker (Codex). New group presets: "Dual Coder Debate" (Codex vs Claude with Reviewer as judge) and "Codex Build + Claude Review" (Codex implements, Claude reviews and tests). Removed "Full Ensemble" and "Code Review Pair" presets. | FR-2, FR-16 |
